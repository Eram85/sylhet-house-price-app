...
@st.cache_resource
def load_model():
    model = joblib.load("gbm_house_price_model_clean.pkl")
    columns = joblib.load("gbm_model_columns.pkl")
...
if predict:
    ...
    # One-hot encode location, then align to training columns
    input_data = pd.get_dummies(raw, columns=["Location"])
